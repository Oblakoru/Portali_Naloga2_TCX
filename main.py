   ...
   for datoteka in files:
       try:
           ...
           podatki = PodatkiClass(stevecID, integral_metrics['activity_type'], integral_metrics['distance'],
                                  ...
                                  all_intervals_heart["number_of_intervals"], all_intervals_heart["min_duration_interval"],
                                  all_intervals_heart["max_duration_interval"], all_intervals_heart["avg_duration_interval"],
                                  all_intervals_heart["min_distance_interval"], all_intervals_heart["max_distance_interval"],
                                  all_intervals_heart["avg_distance_interval"],
                                  all_intervals_heart["min_heartrate_interval"], all_intervals_heart["max_heartrate_interval"],
...
listInDatoteka = {"bikingDataPandas.csv": BikingList, "runningDataPandas.csv": RunningList, "otherDataPandas.csv": OtherList}
...
for datoteka, seznam in listInDatoteka.items():
    with open(datoteka, 'w', newline='') as csvfile:
      ...
      csv_writer.writerow(['id', 'activity_type', 'distance', 'duration', 'calories', 'hr_avg', 'hr_max', 'hr_min', 'altitude_avg', 'altitude_max', 'altitude_min', 'ascent', 'descent', 'steps',
                           'num_hills', 'avg_altitude', 'avg_ascent', 'distance_hills', 'hills_share', 'number_of_intervalsPower', 'min_durationPower', 'max_durationPower', 'avg_durationPower', 'min_distancePower', 'max_distancePower', 'avg_distancePower', 'number_of_intervalsHeart',
                           'min_duration_intervalHeart', 'max_duration_intervalHeart', 'avg_duration_intervalHeart', 'min_distance_intervalHeart', 'max_distance_intervalHeart', 'avg_distance_intervalHeart', 'min_heartrate_intervalHeart', 'max_heartrate_intervalHeart', 'avg_heartrate_intervalHeart'])
